...
TEMP_EXTRACT_DIR="$HOME/.local/share/cursor-agent/versions/.tmp-2026.08.25-3e8eec8-$(date +%s)"
...
FINAL_DIR="$HOME/.local/share/cursor-agent/versions/2026.08.25-3e8eec8"
...
ln -s ~/.local/share/cursor-agent/versions/2026.08.25-3e8eec8/cursor-agent ~/.local/bin/agent
ln -s ~/.local/share/cursor-agent/versions/2026.08.25-3e8eec8/cursor-agent ~/.local/bin/cursor-agent
