...
func DefaultGlobal() Global {
	return Global{
		...
		Agents: []Agent{
			{Name: "Claude Code", Command: "claude", SupportsMemory: true, SupportsYolo: true, Description: "Anthropic's Claude Code", YoloFlag: flagDangerouslySkipPerms, SourceURL: officialClaudeInstall, AllowUnverified: true, Params: []Param{modelParam("for example sonnet or opus")}, Memory: memoryFor("claude-code"), EnvPassthrough: []string{"ANTHROPIC_API_KEY", "ANTHROPIC_AUTH_TOKEN", "ANTHROPIC_BASE_URL", "CLAUDE_CODE_OAUTH_TOKEN", "ANTHROPIC_OAUTH_TOKEN", "CLAUDE_CONFIG_DIR"}},
			{Name: "Codex", Command: "codex", SupportsMemory: true, SupportsYolo: true, Description: "OpenAI Codex CLI", YoloFlag: "--dangerously-bypass-approvals-and-sandbox", SourceURL: officialCodexInstall, AllowUnverified: true, Params: []Param{modelParam("for example gpt-5")}, Memory: memoryFor("codex"), EnvPassthrough: []string{"OPENAI_API_KEY", "OPENAI_BASE_URL", "CODEX_HOME"}},
			{Name: "OpenCode", Command: "opencode", SupportsMemory: true, SupportsYolo: true, Description: "OpenCode CLI", YoloFlag: "--auto", SourceURL: officialOpenCodeInstall, AllowUnverified: true, Memory: memoryFor("opencode"), EnvPassthrough: []string{"ANTHROPIC_API_KEY", "OPENAI_API_KEY", "OPENROUTER_API_KEY", "GEMINI_API_KEY"}},
			{Name: "Kimi Code", Command: "kimi", Aliases: []string{"kimi-cli", kimiCodeID}, SupportsMemory: true, SupportsYolo: true, Description: "Moonshot Kimi Code CLI", YoloFlag: flagYolo, SourceURL: officialKimiInstall, AllowUnverified: true, Params: []Param{modelParam("for example k2"), {Name: "query", Flag: "--prompt", Description: "Initial prompt sent to Kimi", TakesValue: true}}, Memory: memoryFor(kimiCodeID), EnvPassthrough: []string{"MOONSHOT_API_KEY", "KIMI_API_KEY", "KIMI_CODE_HOME"}},
			...
			{Name: "Antigravity", Command: "agy", Aliases: []string{"antigravity", antigravID}, SupportsMemory: true, SupportsYolo: true, Description: "Antigravity CLI", YoloFlag: flagDangerouslySkipPerms, SourceURL: officialAntigravityInstall, AllowUnverified: true, Memory: memoryForHarness("antigravity"), EnvPassthrough: []string{"GEMINI_API_KEY", "GOOGLE_API_KEY"}},
			{Name: "Pi", Command: "pi", Aliases: []string{"pi-coding-agent"}, SupportsMemory: true, SupportsYolo: true, Description: "Pi coding agent", YoloFlag: "--approve", SourceURL: officialPiInstall, AllowUnverified: true, NeedsNode: true, Memory: hooksOnlyMemoryIntegration("pi"), EnvPassthrough: []string{"PI_API_KEY", "PI_CODING_AGENT_DIR"}},
			{Name: "Crush", Command: "crush", SupportsMemory: true, SupportsYolo: true, Description: "Charmbracelet Crush (ai-memory managed run only)", YoloFlag: flagYolo, NpmPackage: "@charmland/crush", EnvPassthrough: []string{"ANTHROPIC_API_KEY", "OPENAI_API_KEY", "OPENROUTER_API_KEY"}},
			{Name: "Oh My Pi", Command: "omp", Aliases: []string{"oh-my-pi"}, SupportsMemory: true, SupportsYolo: true, Description: "Oh My Pi", YoloFlag: "--auto-approve", SourceURL: officialOmpInstall, AllowUnverified: true, Memory: memoryFor("omp"), EnvPassthrough: []string{"PI_API_KEY", "PI_CODING_AGENT_DIR"}},
			{Name: "Cursor Agent", Command: "cursor-agent", Aliases: []string{"cursor"}, SupportsMemory: false, SupportsYolo: true, Description: "Cursor Agent CLI", YoloFlag: flagYolo, SourceURL: officialCursorInstall, AllowUnverified: true, Memory: memoryFor("cursor"), EnvPassthrough: []string{"CURSOR_API_KEY"}},
			{Name: "Grok", Command: "grok", SupportsMemory: true, SupportsYolo: true, Description: "Grok CLI", YoloFlag: "--always-approve", SourceURL: officialGrokInstall, AllowUnverified: true, Memory: memoryFor("grok"), EnvPassthrough: []string{"XAI_API_KEY", "GROK_API_KEY"}},
			...
			{Name: "Gemini CLI", Command: "gemini", Aliases: []string{geminiCLIID}, SupportsMemory: false, SupportsYolo: true, Description: "Google Gemini CLI", YoloFlag: flagYolo, NpmPackage: "@google/gemini-cli", Params: []Param{modelParam("for example gemini-2.5-pro")}, Memory: memoryFor(geminiCLIID), EnvPassthrough: []string{"GEMINI_API_KEY", "GOOGLE_API_KEY", "GOOGLE_APPLICATION_CREDENTIALS"}},
			{Name: "Qwen Code", Command: "qwen", Aliases: []string{"qwen-code"}, SupportsMemory: false, SupportsYolo: true, Description: "Alibaba Qwen Code CLI", YoloFlag: flagYolo, NpmPackage: "@qwen-code/qwen-code", EnvPassthrough: []string{"DASHSCOPE_API_KEY", "OPENAI_API_KEY"}},
			{Name: "Aider", Command: "aider", SupportsMemory: false, SupportsYolo: true, Description: "Aider CLI", YoloFlag: "--yes-always", EnvPassthrough: []string{"ANTHROPIC_API_KEY", "OPENAI_API_KEY"}},
			...
			{Name: "Kiro CLI", Command: "kiro-cli", Aliases: []string{"kiro"}, SupportsMemory: true, SupportsYolo: true, Description: "Amazon Kiro CLI", YoloFlag: "--trust-all-tools", Memory: memoryFor("kiro-cli"), EnvPassthrough: []string{"AWS_PROFILE", "AWS_REGION", "KIRO_HOME"}},
			{Name: "Command Code", Command: "command-code", Aliases: []string{"commandcode", "cmdc", "cmd"}, SupportsMemory: true, SupportsYolo: true, Description: "Command Code CLI", YoloFlag: flagYolo, Memory: memoryFor("command-code"), EnvPassthrough: []string{"ANTHROPIC_API_KEY", "OPENAI_API_KEY"}},
